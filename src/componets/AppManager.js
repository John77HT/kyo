...
const VehiculosControllers = require('../controllers/VehiculosControllers'); // Controlador de vehículos
...
class AppManager {
    ...
    #prepareRouting = async () => {
        ...
        const oVehiculosControllers = new VehiculosControllers(); // Controlador de vehículos
